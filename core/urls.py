...
urlpatterns = [
    ...
    # Transfer
    path('search-account/', transfer.search_users_account_numbers, name='search-account'),
    ...
    path('amount-request-cofirmation/<account_number>/<transaction_id>/', payment_request.AmountRequestConfirmation, name='amount-request-confirmation'),
