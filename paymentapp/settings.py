...
SECRET_KEY = 'django-insecure-^s_4*4z9k9)$$3gth@@*e)x!lf&r3ezxtkn$hbm-@kqnsmp^ag'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'account.context_processors.kyc_context_processor'
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    "copyright": "Paylio - All Rights Researved @ Copyright 2023",
