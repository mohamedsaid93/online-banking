# Generated by Django 4.2.4 on 2023-09-18 17:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh1234567890', length=10, max_length=7, prefix='217', unique=True)),
                ...
                ('recommonded_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='recommonded_by', to=settings.AUTH_USER_MODEL)),
